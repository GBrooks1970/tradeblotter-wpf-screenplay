...
order-placement scenarios plus four cancellation/state examples. A Windows CI workflow runs the complete verification
...
remaining ticker, WinAppDriver and Ranorex work with comparative
...
the CI gate: seven builds and 45 tests with TRX output and exact-count checks.
